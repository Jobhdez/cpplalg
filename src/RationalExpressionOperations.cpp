...
namespace RationalExpression {
  template<typename T>
  vector<vector<T>> add(const vector<vector<T>> &rat1, const vector<vector<T>> &rat2) {
    ...
    template<typename T>
    vector<vector<T>> sub(const vector<vector<T>> &rat1, const vector<vector<T>> &rat2) {
    assert(rat1[0].size() == rat2[0].size()); // numerators need to be equal
    assert(rat1[1].size() == rat2[1].size()); // denominators need to be equal
  ...
  template<typename T>
  vector<vector<T>> mul(const vector<vector<T>> &rat1, const vector<vector<T>> &rat2) {
    assert(rat1[0].size() == rat2[0].size()); // numerators need to be equal
    assert(rat1[1].size() == rat2[1].size()); // denominators need to be equal
  ...
  template<typename T>
  void print(const vector<vector<T>> &rat) {
