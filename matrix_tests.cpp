...
std::vector<std::vector<double>> elements2 = {{2,1,5},{2,3,4},{0,1,0}};
std::vector<std::vector<double>> elements3 = {{1,-1,2},{0,-3,1}};
Matrix m0(elements2);
Matrix m1(m1_elements);
Matrix m2(m2_elements);
Matrix mat3(elements3);
...
std::vector<double> vec2 = {1, -3};
std::vector<double> v = mat3.mulByVector(vec);
